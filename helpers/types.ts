...
export type eNetwork = eEthereumNetwork | ePolygonNetwork | eXDaiNetwork | eAvalancheNetwork | eKlaytnNetwork;
...
export enum eContractid {
  ...
  GeistToken = 'GeistToken',
  VeNFT = 'VeNFT',
  LPToken = 'LPToken',
  TokenLocker = 'TokenLocker',
  SolidexVoter = 'SolidexVoter',
  MultiFeeDistribution = 'MultiFeeDistribution',
  ProtocolOwnedDEXLiquidity = 'ProtocolOwnedDEXLiquidity',
  Treasury = 'Treasury',
  FairAssetContract = 'FairAssetContract'
}
...
export interface iKlaytnParamsPerNetwork<T> {
  [eKlaytnNetwork.baobab]: T;
  [eKlaytnNetwork.cypress]: T;
}
