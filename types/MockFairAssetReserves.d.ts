...
interface MockFairAssetReservesInterface extends ethers.utils.Interface {
  functions: {
...
export class MockFairAssetReserves extends Contract {
  ...
  interface: MockFairAssetReservesInterface;
