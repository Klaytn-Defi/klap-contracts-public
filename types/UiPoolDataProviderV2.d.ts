...
interface UiPoolDataProviderV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "getReserveData(address,address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "isPaused", values: [string]): string;
  encodeFunctionData(
...
export class UiPoolDataProviderV2 extends Contract {
  ...
  functions: {
    ...
    "getReserveData(address,address)"(
      provider: string,
      reserve: string,
      overrides?: CallOverrides
    ): Promise<{
  ...
  isPaused(provider: string, overrides?: CallOverrides): Promise<boolean>;
  ...
  estimateGas: {
    ...
    isPaused(provider: string, overrides?: CallOverrides): Promise<BigNumber>;
