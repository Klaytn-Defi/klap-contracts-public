...
interface UiIncentiveDataProviderV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "getReserveIncentiveData(address,uint256)": FunctionFragment;
    "getReservesIncentivesData(address)": FunctionFragment;
    "getUserReservesIncentivesData(address,address)": FunctionFragment;
    "getUserReservesIncentivesDataSingle(address,address,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "getReserveIncentiveData",
  ...
  encodeFunctionData(
    functionFragment: "getUserReservesIncentivesDataSingle",
...
export class UiIncentiveDataProviderV2 extends Contract {
  ...
  functions: {
    ...
    "getReserveIncentiveData(address,uint256)"(
      provider: string,
      i: BigNumberish,
      overrides?: CallOverrides
    ): Promise<{
    ...
    getUserReservesIncentivesDataSingle(
      provider: string,
      user: string,
      i: BigNumberish,
      overrides?: CallOverrides
    ...
    "getUserReservesIncentivesDataSingle(address,address,uint256)"(
      provider: string,
      user: string,
      i: BigNumberish,
      overrides?: CallOverrides
