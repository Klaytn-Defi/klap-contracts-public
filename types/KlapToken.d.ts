...
interface KlapTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "burnSpecial(address,uint256)": FunctionFragment;
    "decimals()": FunctionFragment;
    "maxSupplyAfterBurns()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "burnSpecial",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "decimals", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "maxSupplyAfterBurns",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class KlapToken extends Contract {
  ...
  functions: {
    ...
    maxSupplyAfterBurns(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
  ...
  maxSupplyAfterBurns(overrides?: CallOverrides): Promise<BigNumber>;
