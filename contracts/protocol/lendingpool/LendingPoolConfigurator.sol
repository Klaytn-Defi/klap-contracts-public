...
contract LendingPoolConfigurator is VersionedInitializable, ILendingPoolConfigurator {
  ...
  function _initReserve(ILendingPool _pool, InitReserveInput calldata input) internal {
    ...
    incentivesController.addPool(aTokenProxyAddress, 1);
    ITreasury(input.treasury).addReward(aTokenProxyAddress);
    ...
    incentivesController.addPool(variableDebtTokenProxyAddress, 1);
